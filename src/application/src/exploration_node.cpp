...
geometry_msgs::PoseStamped uav_origin_pose;
...
void map_callback(const nav_msgs::OccupancyGrid &map_occupancy)
{
    ...
    goalpose_pub.publish(uav_goal_pose);
...
int main(int argc, char **argv)
{
    ...
    goalpose_pub = nh.advertise<geometry_msgs::PoseStamped>("/goal_pose", 1);
    ros::spin();
    return 0;
}